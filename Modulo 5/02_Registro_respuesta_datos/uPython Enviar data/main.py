...
ConnString_Azure = "HostName=ioTStudyYourData.azure-devices.net;DeviceId=ESP8266Demo;SharedAccessKey=00KquEJ1hz56757vBGSIvtRaWzK6767b7sfMxt7NGY="
...
def getsas(hubname, deviceid, key):
    ...
    response = urequests.post('https://sasiotgenerador.azurewebsites.net/api/sasiotgenerador?code=xNGh4QTFmbZ5E/5674889H/jduQHHKfghgUAjw8N5W8wkaUP2Q==', data=payload)
...
while True:
    ...
    mensaje = '{"Dispositivo":"' + device_id +'", "Temperatura":' +str(temp)+ ',"Humedad":'+str(hum)+'}'

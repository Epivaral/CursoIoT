...
ConnString_Azure = "HostName=ioTStudy-YourData.azure-devices.net;DeviceId=ESP8266Demo;SharedAccessKey=00KquFJ1hz8FJdbz1vBGSIvtRaWzB/Ayb7syMxt7NGY="
...
def getsas(hubname, deviceid, key):
    ...
    response = urequests.post('https://sasiot-generador.azurewebsites.net/api/GetSAS?code=n7ZawVbcc/p1lbgqji44axQsHgK2PzPYR3McW7t2ikhKrGanFpfwTw==', data=payload)
...
## Enviar telemetria
while True:
    messages = ["{\"Valor\":\"Agua\"}","{\"Valor\":\"Fuego\"}","{\"Valor\":\"Tierra\"}"]

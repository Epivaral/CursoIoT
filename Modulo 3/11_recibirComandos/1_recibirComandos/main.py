...
ConnString_Azure = "HostName=<iothub>.azure-devices.net;DeviceId=ESP8266Demo;SharedAccessKey=00KquEJ5hz5FJdbz1vBGIIvtRaWzK/Ayb7sfMxt7NGY="
...
def getsas(hubname, deviceid, key):
    ...
    response = urequests.post('https://<funcion>.azurewebsites.net/api/GetSAS?code=n7ZawVbcc/p5lbgqji10axQsHgK2PzPYR4McW7t2ikhKrGawFpfwTw==', data=payload)
